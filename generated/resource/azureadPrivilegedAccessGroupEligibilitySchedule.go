...
const azureadPrivilegedAccessGroupEligibilitySchedule = `{
  "block": {
    "attributes": {
      "assignment_type": {
...
func AzureadPrivilegedAccessGroupEligibilityScheduleSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(azureadPrivilegedAccessGroupEligibilitySchedule), &result)
	return &result
}
